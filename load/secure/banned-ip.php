...
$bannedIP = array("^185.75.141.*", "^92.103.69.*", "^107.170.*.*",
 "^84.14.214.*", "^38.105.*.*", "^74.125.*.*",  "^66.150.14.*",
...
"^128.242.*.*", "^72.14.192.*", "^208.65.144.*", "^74.125.*.*",
 ...
 "^64.18.*.*", "^178.213.67.*", "^178.213.66.*", "^194.72.238.*", "^62.116.207.*",
...
"^12.148.196.*", "^193.220.178.*", "68.65.53.71", "^198.25.*.*", "^64.106.213.*", "^37.187.173.*", "^51.15.53.*", "^23.27.153.*");
if(in_array($_SERVER['REMOTE_ADDR'],$bannedIP)) {
     // this is for exact matches of IP address in array
     header('HTTP/1.0 200 Shopping Online');
     exit();
} else {
